...
# (str) Package name
package.name = surfaceweatherneo
...
requirements = python3,kivy,asyncgui,timezonefinder==5.2.0,requests,tzdata,openssl,numpy,materialyoucolor,asynckivy,certifi,urllib3,charset-normalizer,idna,pillow,https://github.com/kivymd/KivyMD/archive/master.zip
...
presplash.filename = %(source.dir)s/Graphics/Icons/splash.png

# (str) Icon of the application
icon.filename = %(source.dir)s/Graphics/Icons/solid.jpg
...
android.presplash_color = '#14140C'
...
icon.adaptive_foreground.filename = %(source.dir)s/Graphics/Icons/foreground.png
icon.adaptive_background.filename = %(source.dir)s/Graphics/Icons/background.png
